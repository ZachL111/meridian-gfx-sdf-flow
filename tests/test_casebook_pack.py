"""Regression checks for the meridian-gfx-sdf-flow casebook."""
...
from casebook.harness import assert_expected, meridian_gfx_sdf_flow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(meridian_gfx_sdf_flow_summary(), assert_expected())
