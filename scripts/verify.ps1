...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-meridian-gfx-sdf-detail.ps1

dart tests/test_domain_review.dart

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-meridian-gfx-sdf-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-meridian-gfx-sdf-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-meridian_gfx_sdf_flow-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
