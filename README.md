...
meridian-gfx-sdf-flow is a Dart project for graphics. It focuses on this technical goal: Design a Dart verification harness for sdf systems, covering constraint solving, bounded scenario files, and failure-oriented tests.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 166, risk penalty 4, latency penalty 2, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
