...
`meridian-gfx-sdf-flow` is centered on graphics work in Dart. The technical target is: Design a Dart verification harness for sdf systems, covering constraint solving, bounded scenario files, and failure-oriented tests.
...
The score is deterministic. The current threshold is 166. Risk has a penalty of 4, latency has a penalty of 2, and weight contributes a bonus of 2.
